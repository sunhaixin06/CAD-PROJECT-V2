...
@Component({
  templateUrl: './businessLogGrid.component.html',
  styleUrls: ['./businessLogGrid.component.css']
})
export class BusinessLogGridComponent implements OnInit {
  ...
  // public logLevalList: string[] = ['TIMER', 'COUNTER', 'HISTOGRAM', 'METER'];
  ...
  qingkong() {
    ...
    $('#s1').text('日志类型').removeClass('checked');
    this.chongzhi();
    this.state = {
      skip: 0,
      take: 100,
