...
export class EchartComponent implements OnInit {
  ...
  constructor(private echartService: EchartService, private activeRouter: ActivatedRoute) {
    setTimeout(() => {
  ...
  ngOnInit() {
    ...
    //   this.echartService.getEchartData(params.system, params.id).map((rsp: Response) => {
    //     return rsp.json();
    //   }).subscribe((data) => {
    //     console.log('获取' + params.system + '系统 ID为' + params.id + '的echart信息');
    //     console.log(data);
